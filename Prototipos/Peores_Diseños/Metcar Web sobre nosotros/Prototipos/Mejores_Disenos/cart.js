...
(function () {
  ...
  function itemHTML(it) {
    ...
    return '<div class="mc-ci' + (isNew ? ' is-new' : '') + '" data-line="' + esc(it.line) + '">' +
      ...
      '<div class="mc-ci-thumb">' + icon + '</div>' +
...
.mc-ci-thumb{width:62px;height:62px;flex-shrink:0;border-radius:2px;background:linear-gradient(150deg,#23211e 0%,#161412 70%,#0f0d0b 100%);display:flex;align-items:center;justify-content:center;overflow:hidden;border-left:3px solid var(--mc-red)}
